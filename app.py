...
if not df.empty:
    ...
    with col3:
        ...
        if score >= 85:
            ...
            st.markdown("<div style='margin-top: -60px; margin-left: 30px; text-align: right;'><img src='https://raw.githubusercontent.com/tws5d/Cycle-Parlay-Evaluator/main/Playable.png' width='140'></div>", unsafe_allow_html=True)
        else:
