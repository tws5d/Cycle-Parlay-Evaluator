        ...
        if not df_pitcher.empty:
            ...
            with wind_col:
                ...
                if wind_speed and wind_speed > 0:
                    ...
                    st.markdown(f"<img src='{wind_image_path}' width='160' style='margin-top: -43px; margin-left: -10px;'>", unsafe_allow_html=True)
                    st.markdown(f"<div style='text-align: center; margin-left: -10px; margin-top: -10px;'>{wind_speed:.1f} mph</div>", unsafe_allow_html=True)
